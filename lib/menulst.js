...
const mod_node_config = require('./node-config-file');
    ...
    if (os === 'smartos') {
        ...
        result.push(
            fmt('kernel %s boot=live console=ttyS0 console=tty0 ' +
                ...
                kernel, mac_dashed, c.ip, c.netmask,
        ...
        result.push(fmt('module %s://%s%s type=file name=etc/%s',
            proto, opts.serverIp, mod_node_config.bootPath,
            mod_node_config.fileName));
    }
