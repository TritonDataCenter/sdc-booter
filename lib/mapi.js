...
buildSmartOSMenuLst = function(mac, c) {
    ...
    var d = new Date();
    var extra = ',boot_time=' + d.getFullYear() + ":" + d.getMonth() + ":" +
      d.getDate() + ":" + d.getHours() + ":" + d.getMinutes() + ":" +
      d.getSeconds();

    for (var n in c.nic_tags) {
      // Allow the kernel args to override nic tags
      if (c.kernel_args.hasOwnProperty(n + "_nic")) {
        slog("[" + mac + "] " + "WARNING: kernel args override of '" +
            n + "_nic'");
      } else {
        extra += "," + n + "_nic=" + c.nic_tags[n];
      }
